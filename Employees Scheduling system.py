...
class authentification:
    def __init__(self,username='Lameck Odiwuor',password='tangimeko75830'):
        self.username=username
        self.password=password
        self.upass=1
    def Authentification(self):
        if (self.username==user_name1_.get() and self.password==password_name1_.get()):
             self.upass=1
        else:
              msg.showwarning("Authentification:","LOG IN  FAILED !!! TRY AGAIN.")
...
user_name.grid(column=0,row=7)
user_name1_=tk.Entry(labelframe,relief=tk.SUNKEN,textvariable=name1_,width=50)
user_name1_.focus()
user_name1_.grid(column=1,row=7)
name2_=tk.StringVar()
fill_name=tk.Label(labelframe,text="  ",bg='yellow')
fill_name.grid(column=0,row=9)
password_name=tk.Label(labelframe,text="Password :",bg='yellow',fg='blue')
password_name.grid(column=0,row=10)
password_name1_=tk.Entry(labelframe,relief=tk.SUNKEN,textvariable=name2_,width=50)
password_name1_.grid(column=1,row=10)
fill_name=tk.Label(labelframe,text="  ",bg='yellow')
...
create.grid(column=1,row=12,sticky='WE')
...
class Create:
       ...
       #New window for the newrecord class.
         def show(self):
              ...
              labelframe=tk.LabelFrame(win,text="Create New Employees Records:",bg='yellow')
              labelframe.grid(column=0,row=0)
              name1=tk.StringVar()
              first_name=tk.Label(labelframe,text="First Name:",bg='yellow',fg='blue')
              first_name.grid(column=0,row=0)
              ...
              create=tk.Button(labelframe,text=" New Record ",font='yellow',bg='blue')
              create.grid(column=9,row=9)
              win.mainloop()
...
filemenu.add_separator()
filemenu.add_command(label="UpDate",command=Update_Record)
filemenu.add_separator()
...
editmenu.add_separator()
editmenu.add_command(label="Delete",command= Delete_Record)
editmenu.add_separator()
editmenu.add_command(label="insert",command=Create_Record)
...
tabcontrol2.add(male_tab0,text="Male prensent Employees:")
...
tabcontrol2.add(female_tab0,text="Female prensent Employees:")
...
scrol_List.grid(column=0,row=10,sticky='WS')
...
Employees_Present=scrolledtext.ScrolledText(labelframe,width=166,height=34,fg='blue',wrap=tk.WORD,font=("arial",11))
...
def Female_Absent_employees():
    l=list(str(datetime.datetime.now()))
